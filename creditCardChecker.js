...
// This will validate all the cards
function validateCred(arr) {
  ...
  for (let j = arr.length - 2; j >= 0; j = j - 2) {
    const mul1 = arr[j] * 2;
  ...
  //Total of card number using Luhn Algorithm 
  const cardNum = checkDigit + checkDigit2;
...
//This function will give result of all the valid cards
